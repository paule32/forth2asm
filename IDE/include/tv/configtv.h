...
#define TVCONFIG_TVSRC "../../include /home/jens/Projekte/dBase4Linux/source/parser/forth/tvision/include /usr/include/rhtvision "
#define TVCONFIG_RHIDE_OS_LIBS "stdc++ ncurses m gpm X11 Xmu  alleg"
#define TVCONFIG_TVOBJ "/usr/lib ../../makes /home/jens/Projekte/dBase4Linux/source/parser/forth/tvision/makes /usr/X11R6/lib /usr/lib/x86_64-linux-gnu"
#define TVCONFIG_STDCPP_LIB "-lstdc++"
#define TVCONFIG_SHARED_CODE_OPTION "-fPIC"
#define TVCONFIG_RHIDE_LDFLAGS ""
#define TVCONFIG_RHIDE_LIBS "-L/usr/X11R6/lib -lX11 -lXmu -lgpm -lncurses -lstdc++ -lm -lc  -lalleg"
#define TVCONFIG_LIB_VER "2.2.1"
#define TVCONFIG_EXTRA_INCLUDE_DIRS "/usr/X11R6/include"
#define TVCONFIG_LIB_VER_MAJOR "2"
#define TVCONFIG_INCLUDE "/usr/include/rhtvision "
#define TVCONFIG_CFLAGS   "-O2 -pipe -Wno-packed"
#define TVCONFIG_CXXFLAGS "-O2 -pipe -Wno-packed"
#define TVCONFIG_REF_DIR  "/home/jens/Projekte/dBase4Linux/source/parser/forth/tvision"
